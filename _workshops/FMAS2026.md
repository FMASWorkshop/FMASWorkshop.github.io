...
For inspiration, please see the Mural boards (virtual white boards) that capture our previous discussion sessions. There is one from [FMAS 2024](https://fmasworkshop.github.io/discussions/FMAS2024/) and one from [FMAS2025](https://fmasworkshop.github.io/discussions/FMAS2025/).
You can also see the papers in our Special Issue of the Science of Computer Programming journal, [Advances in Formal Methods for Autonomous Systems](https://www.sciencedirect.com/special-issue/10SCDD2TDDP).
The Keynote talks from FMAS 2025 are also available as a [YouTube playlist here.](https://www.youtube.com/playlist?list=PLd2GI9KRfS3Y)
...
FMAS recommends that authors do not use LLMs to produce text, images, tables, figures, code, etc. for their papers.
However, if the authors decide to use AI to generate content (including but not limited to text, images, and code), then the content and the AI system that was used must be explicitly disclosed in a section titled "AI Usage". 

The use of AI systems for editing and grammar enhancements is allowed, but the authors need to disclose it. 

All the references should contain either a DOI or a URL.


### Submission Details
We intend to publish with EPTCS; Submissions must be prepared using the [EPTCS LaTeX style](http://style.eptcs.org/).
{% if site.data.fmas2026.show_easychair_link == true%}
Please submit your paper via EasyChair [{{site.data.fmas2026.easychair}}]({{site.data.fmas2026.easychair}}).
{% else %}
  Papers submission with EasyChair will be available soon.
{% endif %}
...
Submission dates are in the [Anywhere On Earth (AOE)](https://www.timeanddate.com/time/zones/aoe) timezone.
...
* At least one author per paper must register and pay for **on-site** attendance at FMAS, even if the paper will be presented remotely –  this is to ensure we cover the costs of running FMAS as a satellite workshop at ICFEM.
...
<div class="text-image">
  <p>We have confirmed <a href="http://nilsjansen.org/" rel="external">Prof. Nils Jansen <span class="fas fa-external-link-alt"></span></a> from the Ruhr-University Bochum in Germany, where he is the chair of Artificial Intelligence and Formal Methods. He is also an Professor of Safe and Dependable AI at Radboud University Nijmegen, in The Netherlands. Check back soon for more information on his invited talk at FMAS 2026.</p>
  <image src="{{site.images}}Nils.webp" />
</div>
<br>
  {{talk.bio}}
...
<article class="" markdown="1">
<div class="text-image">
  <image src="{{site.images}}Elizabeth_Polgreen.webp" />
  <p>
    We have also confirmed <a href="https://polgreen.github.io/" rel="external">Dr. Elizabeth Polgreen <span class="fas fa-external-link-alt"></span></a> from the School of Informatics at the University of Edinburgh.
    She is interested in (formal and machine learning-based) synthesis techniques and the use of synthesis to increase the scalability of verification. She holds a research fellowship from the Royal Academy of Engineering.
    Check back soon for more information on her invited talk at FMAS 2026.
  </p>
</div>
<br>
  {{talk.bio}}
...
* **Programme Committee Co-chair**: {% include ext_link.html text="Dr Akhila Bairy" link="https://orcid.org/0000-0002-8796-1474" %} Karlsruhe Institute of Technology, Germany 
* **Deputy PC Chair**: {% include ext_link.html text="Diana Carolina Benjumea Hernandez" link="https://orcid.org/0000-0003-1840-7178" %}  University of Manchester, UK
* **Deputy PC Chair**: {% include ext_link.html text="Thomas Flinkow" link="https://www.cs.nuim.ie/~tflinkow/" %} Maynooth University, Ireland
...
*  {% include ext_link.html text="Alberto Tagliaferro" link="https://scholar.google.com/citations?user=zou_1wcAAAAJ&hl=it" %} Politecnico di Milano, Italy
