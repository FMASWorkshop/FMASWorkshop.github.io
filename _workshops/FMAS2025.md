...
For the first time, FMAS 2025 will honour the best paper selected with respect to reviews, program committee discussions, and conference presentations with an award.
...
We are pleased to be able to offer free registration (**FMAS only**) for a limited number of students attending the FMAS 2025. This is possible thanks to sponsorship by the [Formal Methods Europe](https://www.fmeurope.org/) association. 
