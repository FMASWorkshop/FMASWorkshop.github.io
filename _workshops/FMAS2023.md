...
* At least one author per paper must register for **in-person** attendance at FMAS through the [iFM registration system](https://liacs.leidenuniv.nl/~bonsanguemm/ifm23/registration.html),
...
* If you want to participate **remotely**, please fill in the following, three question form:  [https://form.jotform.com/mariefarrell/fmas2023](https://form.jotform.com/mariefarrell/fmas2023)
* If you are presenting your paper and wish to do so remotely, unfortunately you will have to register twice – once for each of the above links. 
