...
We intend that accepted papers will be published via [EPTCS](http://www.eptcs.org/). The proceedings will be available before the workshop.
...
You will need to select one of the four submission categories during submission, under the heading 'Topics'.
