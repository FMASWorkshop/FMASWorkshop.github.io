...
The two main days of FMAS 2024 (the 11th and 12th) will be held at the [Core Technology Facility](https://www.conference.manchester.ac.uk/venues/search/details/?property=63) on the corner of Grafton Street and Upper Brook Street. The shared invited talk and joint session (on the 13th) will be a [The Whitworth Gallery](https://www.whitworth.manchester.ac.uk/visit/) on Oxford Road. The iFM website gives some more details about these [venues](https://ifm2024.cs.manchester.ac.uk/venue.html).
